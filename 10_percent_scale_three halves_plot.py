...
tex_data_50 = tex_data_50*50**1.5
...
tex_data_70 = tex_data_70*70**1.5
del ds
...
tex_data_80 = tex_data_80*80**1.5
del ds
...
tex_data_120 = tex_data_120*120**1.5
del ds
...
tex_data_160 = tex_data_160*160**1.5
del ds
...
plt.suptitle('Texture lengthscales multiplied by window size')
fig.tight_layout()
#plt.show()
plt.savefig(r"C:\workspace\Merged_SS\window_analysis\10_percent_shift\output\Window_analysis_scaling.png",dpi=1000)
