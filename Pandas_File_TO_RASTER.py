...
if  __name__ == '__main__':
    ...
    #Data Import Section
    epsg_code=26949
    fIn = r"C:\workspace\Merged_SS\subset\2012_05_analysis.csv"
    ...
    driverName= 'GTiff'
    tex_outFile = r'C:\workspace\Texture_Classification\output\tex_2012_05.tif'
    ss_outFile = r'C:\workspace\Texture_Classification\output\ss_2012_05.tif'
    power =1
    smoothing=20         
    proj = data['proj']
