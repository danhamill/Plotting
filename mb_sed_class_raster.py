...
if  __name__ == '__main__':
    ...
    out_df = pd.read_csv(r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\may2014_mb6086r_sedclass\x_y_sedclass_dt_5class_25cm.xyz",
                         sep =',', names =['easting','northing','sed5class'] )
    date = '2014_05'
    epsg_code=26949
    ...
    ss_grid_array = np.array(data['sed5class'])
    ...
    driverName= 'GTiff'    
    proj = data['proj']
    ss_outFile = r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\may2014_mb6086r_sedclass" + os.sep +'mb_sed5class_' + date + '_raster.tif'
