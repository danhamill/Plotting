...
lbound, ubound = get_bounds(df_50)
...
lbound, ubound = get_bounds(df_70)
...
m = Basemap(projection='merc', 
            ...
            urcrnrlat=np.max(glat))
im = m.contourf(x,y,ss_data_50.T, cmap='Greys_r',levels=ss_level)
lbound, ubound = get_bounds(df_120)
...
plt.savefig(r"C:\workspace\Merged_SS\window_analysis\10_percent_shift\output\tex_percentile_50th-75th.png",dpi=1000)
#plt.show()
