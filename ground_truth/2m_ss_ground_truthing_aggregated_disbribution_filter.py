...
#Buffered points
buff_shp = r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\output\shapefiles\may2014_2m_buff.shp"

#Resampled sed5Class
sed_pts = r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\may2014_mb6086r_sedclass\xy_sed5class_2m.csv"
...
z_stats = zonal_stats(buff_shp ,ss_r28,
...
m.readshapefile(r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\output\shapefiles\may2014_2m_buff_geo","layer",drawbounds = False)
...
plt.savefig(r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\output\mb_sed_class_ground_truth_2m_agg_dist_filtered.png",dpi=600)
