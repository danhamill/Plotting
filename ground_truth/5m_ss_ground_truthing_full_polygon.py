...
#WGS shape files
buf_geo = r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\output\shapefiles\may2014_5m_buff_geo.shp"
...
plt.savefig(r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\output\mb_sed_class_ground_truth_5m_full_polygon.png",dpi=1000)
