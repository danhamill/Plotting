...
z_stats_28 = zonal_stats(buff_shp, ss_r28, stats=['count'], raster_out=True)
...
plt.savefig(r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\output\mb_sed_class_ground_truth_10m_agg_dist.png",dpi=600)
